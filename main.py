...
while True:
    ...
    if multiLandMarks:
        ...
        # Print number of fingers and press keys which uses autopygui using this package we bind our input to keystrokes
        if upCount == 1:
            p.press("up")
            ...
            p.press("down")
            cv2.putText(img, "Volume Down", (5, 50), cv2.FONT_HERSHEY_SIMPLEX, 2, (0, 0, 255), 2)
